---
title: "ALY6050_MOD1Project_SherafatiS "
...
### Appendix
```{r code=readLines(knitr::purl('~/Documents/Northeastern University/ALY 6050/ALY6050_MOD1Project_SherafatiS.Rmd', documentation = 0)), eval = FALSE}
```
